...
本流程随 spiderfly-instructions 0.1.3 提供，不修改输入 Excel。
...
def run_flow(
    ...
    status_column: str = "状态", amount_column: str = "金额",
    left_status: str = "待处理", right_status: str = "已完成",
) -> dict:
...
def main() -> int:
    ...
    parser.add_argument("--status-column", default="状态")
    parser.add_argument("--amount-column", default="金额")
    parser.add_argument("--left-status", default="待处理", help="被减数对应的状态")
    parser.add_argument("--right-status", default="已完成", help="减数对应的状态")
