# DrissionPage：⤵️ 浏览器下载
工具：drissionpage
接入状态：仅知识参考；未接入 SpiderFly AI 执行工具和 collection-v1
主题：⤵️ 浏览器下载；download/browser.md
版本：用户提供的 Markdown 文档 4.1.1.2
核对日期：2026-09-11
适用范围：用户文档原生 API 参考；未进行库运行验证
资料路径：download/browser.md
资料校验：efce79b2b8e4f3b2d809f56e11993a2de7e8af2093976d2e7be6aaf250c25c93
来源：[官方对应章节（可变网页，不保证与本地版本一致）](https://www.drissionpage.cn/download/browser/)
