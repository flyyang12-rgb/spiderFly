...
主题：⚙️ 全局设置；advance/settings.md
版本：用户提供的 Markdown 文档 4.1.1.2
核对日期：2026-09-11
适用范围：用户文档原生 API 参考；未进行库运行验证
资料路径：advance/settings.md
资料校验：db651c1877f5500414d9504ece04a27c993dde906f6127d42416af154d04fb3c
来源：[官方对应章节（可变网页，不保证与本地版本一致）](https://www.drissionpage.cn/advance/settings/)
