# DrissionPage：⚙️ 数据读取加速
工具：drissionpage
接入状态：仅知识参考；未接入 SpiderFly AI 执行工具和 collection-v1
主题：⚙️ 数据读取加速；advance/accelerate.md
版本：用户提供的 Markdown 文档 4.1.1.2
核对日期：2026-09-11
适用范围：用户文档原生 API 参考；未进行库运行验证
资料路径：advance/accelerate.md
资料校验：d9ee03c62a2485359a24143e2a435d1cd262bd1f3420eae78553dc3c6ebf30d4
来源：[官方对应章节（可变网页，不保证与本地版本一致）](https://www.drissionpage.cn/advance/accelerate/)
