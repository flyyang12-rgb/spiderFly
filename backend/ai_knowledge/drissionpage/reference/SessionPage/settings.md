...
主题：🛩️ 页面设置；SessionPage/settings.md
版本：用户提供的 Markdown 文档 4.1.1.2
核对日期：2026-09-11
适用范围：用户文档原生 API 参考；未进行库运行验证
资料路径：SessionPage/settings.md
资料校验：a59fbfc074cd1a607ce27d43381e1c2346c6270b07a46addeef71fba2f7b20a5
来源：[官方对应章节（可变网页，不保证与本地版本一致）](https://www.drissionpage.cn/SessionPage/settings/)
