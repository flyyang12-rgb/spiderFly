# DrissionPage：🛩️ 创建页面对象
工具：drissionpage
接入状态：仅知识参考；未接入 SpiderFly AI 执行工具和 collection-v1
主题：🛩️ 创建页面对象；SessionPage/create_obj.md
版本：用户提供的 Markdown 文档 4.1.1.2
核对日期：2026-09-11
适用范围：用户文档原生 API 参考；未进行库运行验证
资料路径：SessionPage/create_obj.md
资料校验：01dc51d00abb743b77982288be47dfaa21fc618e3b59943979bbf7463c504adb
来源：[官方对应章节（可变网页，不保证与本地版本一致）](https://www.drissionpage.cn/SessionPage/create_obj/)
