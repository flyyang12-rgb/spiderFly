...
主题：🛰️ 元素交互；browser_control/ele_operation.md
版本：用户提供的 Markdown 文档 4.1.1.2
核对日期：2026-09-11
适用范围：用户文档原生 API 参考；未进行库运行验证
资料路径：browser_control/ele_operation.md
资料校验：df3a429852580f9c9b382da4ea942f229db49adc8fb2b172886ab75b92cdf7a7
来源：[官方对应章节（可变网页，不保证与本地版本一致）](https://www.drissionpage.cn/browser_control/ele_operation/)
