# DrissionPage：🛰️ 获取控制台信息
工具：drissionpage
接入状态：仅知识参考；未接入 SpiderFly AI 执行工具和 collection-v1
主题：🛰️ 获取控制台信息；browser_control/console.md
版本：用户提供的 Markdown 文档 4.1.1.2
核对日期：2026-09-11
适用范围：用户文档原生 API 参考；未进行库运行验证
资料路径：browser_control/console.md
资料校验：b119a9c02fb7b72b63f7623b11aaab0229a8edda8c1b97ba60f9e127bf1c2af5
来源：[官方对应章节（可变网页，不保证与本地版本一致）](https://www.drissionpage.cn/browser_control/console/)
