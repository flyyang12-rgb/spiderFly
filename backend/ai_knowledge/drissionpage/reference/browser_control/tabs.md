# DrissionPage：🛰️ 标签页管理
工具：drissionpage
接入状态：仅知识参考；未接入 SpiderFly AI 执行工具和 collection-v1
主题：🛰️ 标签页管理；browser_control/tabs.md
版本：用户提供的 Markdown 文档 4.1.1.2
核对日期：2026-09-11
适用范围：用户文档原生 API 参考；未进行库运行验证
资料路径：browser_control/tabs.md
资料校验：c7e1c34f521d27965d1c5002377a8e73df50422dc2469c97695e28bdd16a063a
来源：[官方对应章节（可变网页，不保证与本地版本一致）](https://www.drissionpage.cn/browser_control/tabs/)
