# DrissionPage：🛰️ iframe 操作
工具：drissionpage
接入状态：仅知识参考；未接入 SpiderFly AI 执行工具和 collection-v1
主题：🛰️ iframe 操作；browser_control/iframe.md
版本：用户提供的 Markdown 文档 4.1.1.2
核对日期：2026-09-11
适用范围：用户文档原生 API 参考；未进行库运行验证
资料路径：browser_control/iframe.md
资料校验：34f1e812c76138ee3d5d6e0b451037e1fda8ab3a9cd1aa2488c94748f1d71d48
来源：[官方对应章节（可变网页，不保证与本地版本一致）](https://www.drissionpage.cn/browser_control/iframe/)
