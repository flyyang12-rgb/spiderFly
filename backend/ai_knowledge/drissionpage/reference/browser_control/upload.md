...
主题：🛰️ 上传文件；browser_control/upload.md
版本：用户提供的 Markdown 文档 4.1.1.2
核对日期：2026-09-11
适用范围：用户文档原生 API 参考；未进行库运行验证
资料路径：browser_control/upload.md
资料校验：39dccf13d7207968eac245c4ba0bd2c2ac6a598cbde59b2fdc9db43ea1e7ca4b
来源：[官方对应章节（可变网页，不保证与本地版本一致）](https://www.drissionpage.cn/browser_control/upload/)
