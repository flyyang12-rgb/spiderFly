# DrissionPage：🛰️ 浏览器启动设置
工具：drissionpage
接入状态：仅知识参考；未接入 SpiderFly AI 执行工具和 collection-v1
主题：🛰️ 浏览器启动设置；browser_control/browser_options.md
版本：用户提供的 Markdown 文档 4.1.1.2
核对日期：2026-09-11
适用范围：用户文档原生 API 参考；未进行库运行验证
资料路径：browser_control/browser_options.md
资料校验：afb357a58ee16e744f55ed6b2e93ebb5586f95fb20adda8c245d7a1de41bc507
来源：[官方对应章节（可变网页，不保证与本地版本一致）](https://www.drissionpage.cn/browser_control/browser_options/)
