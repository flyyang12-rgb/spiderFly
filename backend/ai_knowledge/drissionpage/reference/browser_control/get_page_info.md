# DrissionPage：🛰️ 获取网页信息
工具：drissionpage
接入状态：仅知识参考；未接入 SpiderFly AI 执行工具和 collection-v1
主题：🛰️ 获取网页信息；browser_control/get_page_info.md
版本：用户提供的 Markdown 文档 4.1.1.2
核对日期：2026-09-11
适用范围：用户文档原生 API 参考；未进行库运行验证
资料路径：browser_control/get_page_info.md
资料校验：2e5476f332979998ff5bbceca80a8d8e4afe39dea43ae1c9d5866cac42a83060
来源：[官方对应章节（可变网页，不保证与本地版本一致）](https://www.drissionpage.cn/browser_control/get_page_info/)
