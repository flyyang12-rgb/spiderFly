# DrissionPage：🛰️ 截图和录像
工具：drissionpage
接入状态：仅知识参考；未接入 SpiderFly AI 执行工具和 collection-v1
主题：🛰️ 截图和录像；browser_control/screen.md
版本：用户提供的 Markdown 文档 4.1.1.2
核对日期：2026-09-11
适用范围：用户文档原生 API 参考；未进行库运行验证
资料路径：browser_control/screen.md
资料校验：8f2bb367601f87e5002eac0acea71e4939b8582949d33423027a5e31c126e1d7
来源：[官方对应章节（可变网页，不保证与本地版本一致）](https://www.drissionpage.cn/browser_control/screen/)
