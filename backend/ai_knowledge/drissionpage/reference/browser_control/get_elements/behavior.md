...
主题：🔦 行为模式；browser_control/get_elements/behavior.md
版本：用户提供的 Markdown 文档 4.1.1.2
核对日期：2026-09-11
适用范围：用户文档原生 API 参考；未进行库运行验证
资料路径：browser_control/get_elements/behavior.md
资料校验：92c78d4da0d871a0a00c16802486e407f9cf346d0220d2bdbd125fc456ce4941
来源：[官方对应章节（可变网页，不保证与本地版本一致）](https://www.drissionpage.cn/browser_control/get_elements/behavior/)
