...
主题：🔦 语法速查表；browser_control/get_elements/sheet.md
版本：用户提供的 Markdown 文档 4.1.1.2
核对日期：2026-09-11
适用范围：用户文档原生 API 参考；未进行库运行验证
资料路径：browser_control/get_elements/sheet.md
资料校验：d7ebbdfc51d22a23a8fe59bee5c4e0663fb7cadb49945e86cf042086ac6c8b97
来源：[官方对应章节（可变网页，不保证与本地版本一致）](https://www.drissionpage.cn/browser_control/get_elements/sheet/)
