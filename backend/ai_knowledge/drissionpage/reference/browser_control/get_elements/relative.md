...
主题：🔦 相对定位；browser_control/get_elements/relative.md
版本：用户提供的 Markdown 文档 4.1.1.2
核对日期：2026-09-11
适用范围：用户文档原生 API 参考；未进行库运行验证
资料路径：browser_control/get_elements/relative.md
资料校验：ed1b1d4a5e61242427944b8dea86957968425fbadffffa6b0d23f2fbe9f1d42c
来源：[官方对应章节（可变网页，不保证与本地版本一致）](https://www.drissionpage.cn/browser_control/get_elements/relative/)
