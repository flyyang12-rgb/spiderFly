...
主题：🔦 定位语法；browser_control/get_elements/syntax.md
版本：用户提供的 Markdown 文档 4.1.1.2
核对日期：2026-09-11
适用范围：用户文档原生 API 参考；未进行库运行验证
资料路径：browser_control/get_elements/syntax.md
资料校验：e427a9cb357cb40a5fdd68367bc3b6e74b62a9a5c0d4a242f931a75335835382
来源：[官方对应章节（可变网页，不保证与本地版本一致）](https://www.drissionpage.cn/browser_control/get_elements/syntax/)
