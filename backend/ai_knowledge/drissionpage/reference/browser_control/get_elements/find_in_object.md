# DrissionPage：🔦 页面或元素内查找
工具：drissionpage
接入状态：仅知识参考；未接入 SpiderFly AI 执行工具和 collection-v1
主题：🔦 页面或元素内查找；browser_control/get_elements/find_in_object.md
版本：用户提供的 Markdown 文档 4.1.1.2
核对日期：2026-09-11
适用范围：用户文档原生 API 参考；未进行库运行验证
资料路径：browser_control/get_elements/find_in_object.md
资料校验：b427dd9aefea5dad8e4c08c4b59253349de73934d1e6d1644efabafc23df2e27
来源：[官方对应章节（可变网页，不保证与本地版本一致）](https://www.drissionpage.cn/browser_control/get_elements/find_in_object/)
