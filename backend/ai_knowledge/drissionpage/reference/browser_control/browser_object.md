# DrissionPage：🛰️ 浏览器对象
工具：drissionpage
接入状态：仅知识参考；未接入 SpiderFly AI 执行工具和 collection-v1
主题：🛰️ 浏览器对象；browser_control/browser_object.md
版本：用户提供的 Markdown 文档 4.1.1.2
核对日期：2026-09-11
适用范围：用户文档原生 API 参考；未进行库运行验证
资料路径：browser_control/browser_object.md
资料校验：f42830b67a6d7e438206efb702c71eaff3e24f0ab152f1f5dc35e4d012ac5bd8
来源：[官方对应章节（可变网页，不保证与本地版本一致）](https://www.drissionpage.cn/browser_control/browser_object/)
